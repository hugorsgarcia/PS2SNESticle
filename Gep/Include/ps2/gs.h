...
#define GIF_CTRL	*((volatile u32*)0x12001000)
...
typedef struct {
	...
	unsigned int FLG:2;
	unsigned int NREG:4;
	unsigned int REGS0:4;
	unsigned int REGS1:4;
	unsigned int REGS2:4;
	unsigned int REGS3:4;
	unsigned int REGS4:4;
	unsigned int REGS5:4;
	unsigned int REGS6:4;
	unsigned int REGS7:4;
	unsigned int REGS8:4;
	unsigned int REGS9:4;
	unsigned int REGS10:4;
	unsigned int REGS11:4;
	unsigned int REGS12:4;
	unsigned int REGS13:4;
	unsigned int REGS14:4;
	unsigned int REGS15:4;
